...
<head>
  ...
  <script>
    (function() {
      var COOKIE_NAME = 'introSeen';
      var hasIntro = document.cookie.split('; ').some(function(r) {
        return r.startsWith(COOKIE_NAME + '=');
      });

      if (!hasIntro) {
        // Only hide the page if the loader will run
        document.documentElement.classList.add('app-loading');
      } else {
        // Ensure normal rendering when skipping
